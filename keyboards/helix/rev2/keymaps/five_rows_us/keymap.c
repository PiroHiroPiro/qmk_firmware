...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Esc  | Ctrl | Alt  | CMD  |Lower |Space |   [  |   ]  |Space |Raise |  '   | Left | Down |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
   [_QWERTY] = LAYOUT( \
       ...
       KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_COMM, KC_DOT,  KC_N,    KC_M,    KC_SLSH, KC_MINS, KC_UP,   KC_PIPE , \
       KC_ESC,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_LBRC, KC_RBRC, KC_SPC,  RAISE,   KC_QUOT, KC_LEFT, KC_DOWN, KC_RGHT \
       ),
